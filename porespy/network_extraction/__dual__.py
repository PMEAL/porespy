...
def dual(net=None, solid_dt=None):
    ...
    r"""
    Extract bond and site information of solid and fluid phase.

    Parameters:
    -----------
    net: Dictonary
    A network dictionay generated by extract_pore_network function with dual
    value set to True.
    ...
    Returns:
    --------
    A dictionary containing all the bond and site size data, as well as the
