...
def to_openfoam(im, path='', voxel_size=1, label_boundaries=True):
    r"""
    ...
    path : string or path object
        ...
        extension.
    voxel_size : scalar
        Resolution of the voxels in m/voxel
    label_boundaries : Boolean
        If ``True`` (default) the mesh elements on the image boundaries are
        labelled
...
"""
    ...
    file = file[:index2] + str(voxel_size) + file[index2:]
